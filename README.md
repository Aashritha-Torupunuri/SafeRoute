...
🔗 Live: saferoute.vercel.app

SafeRoute KW screenshot
...
Data Source
Collision records are sourced from the City of Kitchener Open Data portal, covering 8,598 collisions across all Kitchener intersections. Raw CSV records were cleaned, clustered by intersection, and enriched with risk scoring and collision-type breakdowns via a custom data pipeline.
...
Built at Hack to the Future — Laurier Computing Society · March 2026
